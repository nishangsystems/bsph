                ...
                <div>
                    <div id="user-profile-1" class="user-profile row">
                        <div style="width:100%; padding-block:1.5rem; font-size:2rem; font-weight:600; padding-inline:2rem;" class="shadow bg-light mx-1">
                            <span class="d-block w-100 text-danger text-center">PLEASE REMEMBER TO SUBMIT YOUR FORM AT THE END OF THIS PROCESS. PRINT OUT YOUR FORM AND DEPOSIT THEM AT THE SECRETARIAT <span class="text-dark">NEED HELP? CALL - </span>:<span class="text-primary">{{ $help_contacts }}</span></span>
