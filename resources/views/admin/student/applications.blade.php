                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="border-left border-right">
                                ...
                                @if(Auth::user()->hasPermissionTo('delete_application_form') and empty($appl->admitted) and $delete??false == true)
                                    <a onclick="confirm_delete('{{ route('admin.applications.delete', $appl->id)}}', 'You have requested to delete an application form for {{ $appl->name??'' }}. Confirm to proceed.')" class="btn btn-xs btn-danger mt-1">@lang('text.word_delete')</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
